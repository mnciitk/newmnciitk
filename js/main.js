...
function findScrollDirectionOtherBrowsers(event) {
  ...
  if (delta < 0) {
    ...
    if (current < 6) {
      document
        .querySelector(".sec" + current)
        .removeEventListener("wheel", findScrollDirectionOtherBrowsers);
      setTimeout(() => {
        document
          .querySelector(".sec" + current)
          .addEventListener("wheel", findScrollDirectionOtherBrowsers);
      }, 2000);
...
function scrolldown(a, b) {
  ...
  if (x.matches) {
    ...
    if (a == 1) {
      ...
      tl.set(`.sec${a}`, { duration: 0.01, display: "none" });
      // tl.to(`.part${a}3`,{duration: .5,x:'-100%'})
      // tl.to(`.part${a}3`, { duration: .01,display:'none' });
      tl.to(`.sec${a}`, { duration: 0.5 });
      tl.to(`.sec${b}`, { duration: 0.01, display: "flex" }, "-=0.2");
      tl.from(`.sec${b}`, { duration: 0.4, x: "100%" }, "-=0.21");
      tl.to(`.img${b}`, { duration: 0.3, opacity: "1" }).call(updatedown, [
        a,
        b,
      ]);
      tl.to(`.img${b}`, { duration: 0.3, scale: "0.6", x: "40px" });
      tl.to(`.part${b}1`, { duration: 0.5, y: "30px", opacity: "1" });
      tl.to(`.sidenav`, { duration: 0.2, opacity: "1" });
      // tl.set(`.part${a}3`,{x:'0%'})
    } else {
      var tl = gsap.timeline();
      tl.set(`.part${a}3`, { transformOrigin: "left" });
      tl.to(`.sidenav`, { duration: 0.2, opacity: "0" });
      tl.to(`.part${a}1`, { duration: 0.5, y: "-30px", opacity: "0" });
      tl.to(`.part${a}3`, { duration: 0.01, display: "initial" }, "-=0.3");
      tl.from(`.part${a}3`, { duration: 0.5, x: "100%" }, "-=0.31");
      tl.to(`.img${a}`, { duration: 0.3, opacity: "0" });
      tl.set(`.img${a}`, { scale: "0.7", x: "0px" });
      tl.to(`.sec${a}`, { duration: 0.01, display: "none" }, "-=0.2");
      tl.to(`.part${a}3`, { duration: 0.5, x: "-100%" }, "-=0.2");
      tl.to(`.part${a}3`, { duration: 0.01, display: "none" });
      tl.to(`.sec${b}`, { duration: 0.01, display: "flex" }, "-=0.2");
      tl.from(`.sec${b}`, { duration: 0.4, x: "100%" }, "-=0.21");
      tl.to(`.img${b}`, { duration: 0.3, opacity: "1" }).call(updatedown, [
        a,
...
function scrollup(a, b) {
  ...
  if (x.matches) {
    ...
    if (b == 1) {
      ...
      tl.to(`.sidenav`, { duration: 0.2, opacity: "0" });
      tl.to(`.part${a}1`, { duration: 0.5, y: "-30px", opacity: "0" });
      tl.to(`.part03`, { duration: 0.01, display: "initial" }, "-=0.3");
      tl.from(`.part03`, { duration: 0.5, x: "-100%" }, "-=0.31");
      tl.to(`.img${a}`, { duration: 0.3, opacity: "0" });
      tl.set(`.img${a}`, { scale: "0.7", x: "0px" });
      tl.to(`.sec${a}`, { duration: 0.01, display: "none" });
      tl.to(`.part03`, { duration: 0.5, x: "100%" });
      ...
      tl.to(`.sidenav`, { duration: 0.2, opacity: "1" }).call(updateup, [a, b]);
      ...
      tl.set(`.part03`, { display: "none" });
      tl.set(`.part${b}3`, { display: "initial" }, "-=0.5");
      tl.from(`.part${b}3`, { duration: 0.5, x: "-100%" }, "-=0.5");
      tl.to(`.part${b}3`, { duration: 0.5, x: "100%" });
      tl.set(`.part${b}3`, { display: "none" });
      tl.set(`.sec${b}`, { display: "flex" }, "-=0.5");
      tl.from(`.sec${b}`, { duration: 0.5, x: "-100%" }, "-=0.5");
      tl.set(`.img${b}`, { opacity: "1" }).call(updateup, [a, b]);
      tl.to(`.img${b}`, { duration: 0.3, scale: "0.6", x: "40px" });
      tl.to(`.part${b}1`, { duration: 0.5, y: "30px", opacity: "1" });
      tl.to(`.sidenav`, { duration: 0.2, opacity: "1" });
      tl.set(`.part03`, { x: "00%" });
